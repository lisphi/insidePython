...
class Crawler:
    def __init__(self, cookies, root_dir_ids, page_size=100):
        ...
        self.root_dir_ids = root_dir_ids
        self.page_size = page_size
        self.results = []

    def crawl(self):
        for root_dir_id in self.root_dir_ids:
            self.crawl_path(root_dir_id, 1)
...
root_dir_ids = [915179746955665,9323947686058,918851239941680,293780349740992,545434435248127,674699331530837]
crawler = Crawler(cookies, root_dir_ids)
crawler.crawl()