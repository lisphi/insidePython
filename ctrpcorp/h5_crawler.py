...
def create_count_crawler(cookies, service_code, operation):
...
class __Crawler:
    def __init__(self, cookies, query_template, service_code, operation, result_converter, step_in_second):
        self.url = 'http://es.ops.ctripcorp.com/clickhouse/?tableName=log.fx_apirouter_access_log_all'
