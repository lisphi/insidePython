...
def request_count(cookies, service_code, operation, start_time, end_time, total_seconds, step_seconds):
    count_futures = []
...
def main():
    ...
    end_time = start_time + dt.timedelta(days=18)
    total_seconds = int((end_time - start_time).total_seconds())
    step_seconds = 20 * 60 #二十分钟一个任务
    count_results = request_count(cookies, service_code, operation, start_time, end_time, total_seconds, step_seconds)
